    ...
    function updateBasket(e) {
      ...
      d3.json(filepath, function(error, data) {
        ...
        cell.append("title").text(function(d) {
          return d.data.name.substr(d.data.name.indexOf(" ") + 1);
        });
      });
    }
